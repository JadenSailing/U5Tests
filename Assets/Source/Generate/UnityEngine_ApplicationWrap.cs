...
public class UnityEngine_ApplicationWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("EnableLogCallback", get_EnableLogCallback, set_EnableLogCallback);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_EnableLogCallback(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, UnityEngine.Application.EnableLogCallback);
			return 1;
		}
		catch(Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_EnableLogCallback(IntPtr L)
	{
		try
		{
			bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
			UnityEngine.Application.EnableLogCallback = arg0;
			return 0;
		}
		catch(Exception e)
		{
